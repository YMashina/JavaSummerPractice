...
public class Visualisation {
    ...
    public void changes(){
        try (FileWriter writer = new FileWriter("changes.txt", false)) {
    ...
    protected void FloydWarshallAlgo(int MATRIX_CODE, int [][] dist,Label [][] array_of_labels, int i, int j, int k) {
        ...
        array_of_labels[i][k].setTextFill(Color.web("#c1bbff"));
        array_of_labels[k][j].setTextFill(Color.web("#bdffbb"));
        array_of_labels[i][j].setTextFill(Color.web("#ffbbbb"));
