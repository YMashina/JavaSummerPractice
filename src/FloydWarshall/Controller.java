...
import FloydWarshall.BuildGraph;
...
import static FloydWarshall.BuildGraph.Buildgraph;
...
public class Controller {
   ...
   // private TextField filename_textfield;
    ...
    @FXML
    private Button tests_button;

    @FXML
    void tests_func(ActionEvent event) {
        ...
        if(!f.exists() ) {
            alert("Test log has not been created","Please, put test.jar in the current directory");
            return;
        }
        try {
            pp = rr.exec("java -jar test.jar");//change for Linux! "java -jar test.jar"
        } catch (Exception ex) {
            alert("Test log has not been created","Please, put test.jar in the current directory");
       ...
       // System.out.println("Button");
        ...
        alert.setHeaderText("Test log has been created");
        alert.setContentText("test_log.txt is located in the current directory");
    ...
    public static void alert(String alert_message1, String alert_message2){
    ...
    public static void callgraph() throws IOException, InterruptedException {

        /*{Runtime r = Runtime.getRuntime();
        Process p = null;

        try {
            p = r.exec("C:/Program Files/Java/jdk-12.0.1/bin/java.exe -jar buildgraph.jar");//change for Linux!
        } catch (IOException ex) {
